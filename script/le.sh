...
certbot certonly -t -n --agree-tos --renew-by-default --email "${LE_EMAIL}" --webroot -w /usr/share/nginx/html -d ${LE_FQDN} --server https://acme-v02.api.letsencrypt.org/directory
le_result=$?
